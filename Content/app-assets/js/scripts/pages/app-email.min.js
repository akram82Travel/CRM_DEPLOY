$((function () {
    ...
    if ($.app.menu.is_touch_device()) $(".sidebar-menu-list").css("overflow", "scroll"), $(".email-user-list").css("overflow", "scroll"), $(".email-scroll-area").css("overflow", "scroll"), $(".compose-new-mail-sidebar").css("overflow", "scroll");
    else {
    ...
    $(".mail-reply").on("click", (function () {
    ...
    })), t.find(".email-user-list li").on("click", (function () {
        l.toggleClass("show")
    })), $(".go-back, #inbox-menu").on("click", (function (e) {
        e.stopPropagation(), l.removeClass("show")
        ...
        r.find("input:checked").closest("li").remove(), i.find(".selectAll input").prop("checked", ""), 0 == $(".email-user-list .users-list-wrapper li:visible").length ? n.find(".no-results").addClass("show") : n.find(".no-results").hasClass("show") && n.find(".no-results").removeClass("show")
        ...
        })), 0 == $(".email-user-list .users-list-wrapper li:visible").length ? n.find(".no-results").addClass("show") : n.find(".no-results").hasClass("show") && n.find(".no-results").removeClass("show")) : (n.find(".users-list-wrapper li").show(), n.find(".no-results").hasClass("show") && n.find(".no-results").removeClass("show"))
        ...
        a.removeClass("show"), s.removeClass("show"), $("#compose-form").find("input").val(""), $("#compose-form .ql-editor")[0].innerHTML = ""
